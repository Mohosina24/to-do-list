...
function loadTasks() {
    // file jodi na thake empty array return korbe 
    if(!file_exists(TASKS_FILE)){
        return [];
    }
//    file theke data porar jonno ai built if function use kora hoyece
                    ...
                    <?php foreach($tasks as $index => $task): ?>
                        <li class="task-item">
                            <form method="POST" style="flex-grow: 1;">
                                ...
                                <button type="submit" style="border: none; hover:none; background: none; cursor: pointer; text-align: left; width: 100%;">
